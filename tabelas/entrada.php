...
<body class="fund"><br>
    <div class="container mx-auto">
        ...
        <h3 class="d-flex justify-content-center mb-3">Entradas</h3>
       ...
       <div class="box-search">
        ...
        <table class="container">
            <thead>
                <tr class="font">
                    <th>ID_Deposito<span class='fw-semibold'>(Entrada)</span></th>
                    <th>Valor</th>
                    <th>Depositante</th>
                    <th>Depositario</th>
                    <th>Motivo</th>
            ...
            <tbody>
                <?php
                    ...
                    if(isset($_SESSION)) {
                            ...
                            $sql = "SELECT * from tb_deposito";
                            $dados = mysqli_query($conn, $sql);
                            while($linha = mysqli_fetch_assoc($dados)) {
                                echo "<tr>
                                        <td>" . $linha['id_deposito'] . "</td>
                                        <td>" . $linha['valor'] . "</td>
                                        ...
                                        <td>" . $linha['horario'] . "</td>
                                        <td>     	
                                        	<a class='btn btn-sm btn-danger' href='../acaoADM/deletar.php?id_deposito=$linha[id_deposito]'>
